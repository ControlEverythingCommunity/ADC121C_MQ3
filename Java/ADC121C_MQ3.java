...
public class ADC121C_MQ3
{
	public static void main(String args[]) throws Exception
	{
		// Create I2C bus
		I2CBus Bus = I2CFactory.getInstance(I2CBus.BUS_1);
		// Get I2C device, ADC121C_MQ3 I2C address is 0x50(80)
		...
		double concentration = (9.95 / 4096.0) * raw_adc + 0.05;
		
		// Output data to screen
		System.out.printf("Alcohol Concentration : %.2f mg/L", concentration);
	}
}